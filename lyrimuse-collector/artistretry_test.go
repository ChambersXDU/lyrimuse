...
// artistAliasTable 那张手工表 从这条路径退休了(见 retryArtistIdentities
...
// 第三条 QQ 音乐来源(cachedQQArtistCanonicalName)——MusicBrainz 两条都
...
// 本身就该够用，对任何歌手都成立，不需要事先登记。测试案例见 musicBrainzArtistAliases
...
// 这个下场,见 learnedSourceArtistAlias 头注里的测试),本机缓存里同一歌手的成功条目
