...
// ---- 直连优先、直连被打掉就改走系统代理 ----
//
// ,配套 systemproxy.go(那边记着完整的测试数据和"为什么不全局走代理")。
// 一句话:代理在这台机器上是**更差**的通道(Last.fm 测试 p50 0.4s→1.2s、失败率 1%→16%,
...
const (
	...
	// proxyFallbackProxyBudget:走代理的预算。测试经本机 Clash 打 token.get 是 6.5s
