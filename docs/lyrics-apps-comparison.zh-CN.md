...
- **[Lyrimuse](https://github.com/Yudaotor/lyrimuse)**（GPL-3.0，即本项目）——逐字同步歌词，
  ...
  （每首歌的决策过程可查）；翻译、拼音/粤拼/注音假名；可选提交到 ListenBrainz。
...
| 听歌提交 | 可选提交到 ListenBrainz | — | — |
| 展示形态 | 桌面悬浮歌词、菜单栏歌词 | 桌面 + 菜单栏 | 菜单栏、全屏视图、卡拉 OK 弹窗 |
...
可选的 **ListenBrainz 提交**与歌词功能在同一个应用里完成——全部免费、开源、持续维护中。
